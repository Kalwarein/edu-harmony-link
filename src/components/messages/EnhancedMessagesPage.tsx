...
export const EnhancedMessagesPage = ({ user, adminLevel }: MessagesPageProps) => {
  ...
  return (
    <div className="flex flex-col h-screen max-w-7xl mx-auto">
      ...
      {/* Fixed Modern Chat Input */}
      <div className="fixed bottom-0 left-0 right-0 px-3 pb-4 bg-background/70 backdrop-blur-md z-50">
        {replyingTo && (
          <div className="mb-2 p-2 bg-muted/30 border-l-4 border-primary flex items-center justify-between rounded-md">
        ...
        {attachmentFile && (
          <div className="mb-2 p-2 bg-muted/30 flex items-center justify-between rounded-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full bg-muted hover:bg-muted/80 transition"
          >
          ...
          <div className="flex-1 flex items-center bg-muted rounded-full px-3">
            ...
            <button
              ...
              className="ml-2 w-9 h-9 rounded-full bg-white flex items-center justify-center shadow-md disabled:opacity-40 disabled:cursor-not-allowed"
            >
